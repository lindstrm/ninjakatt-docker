...
COPY ninjakatt-plugin-telegram /plugins/ninjakatt-plugin-telegram
RUN cd /plugins/ninjakatt-plugin-telegram && npm install
...
ENV PLUGINS='["files", "logger", "qbittorrent", "movies", "webserver", "torrentrss", "telegram"]'
